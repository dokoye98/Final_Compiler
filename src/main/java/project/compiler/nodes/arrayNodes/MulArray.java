...
public class MulArray extends AssignArrNode {
    public MulArray(List<String> variableNames, ArrayAssignmentNode arrayAssignmentNode, String operator, List<ExpressionNode> indexes, String finalVar) {
